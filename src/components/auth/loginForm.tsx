...
export default function LoginForm() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Usar window.location.href para una recarga completa que sincronice la sesión
      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            disabled={loading || loadingGoogle}
            className="w-full py-2 px-4 bg-white border border-gray-300 hover:bg-gray-50 text-gray-700 rounded-md disabled:opacity-50 flex items-center justify-center gap-2"
          >
